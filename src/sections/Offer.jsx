...
const Offer = () => {
  return (
    <section className="container md:space-y-[64px]">
      <h2 className="font-bold text-3xl md:text-[40px] text-center">What do we offer?</h2>

      <div className="flex flex-wrap items-center justify-between">
        {offerCard.map(({ img, title, desc }, i) => (
          <div key={i} className="flex justify-start items-start gap-6 mt-8 xl:mt-0">
